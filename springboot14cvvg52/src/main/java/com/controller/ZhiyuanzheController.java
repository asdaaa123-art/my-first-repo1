...
public class ZhiyuanzheController {
    ...
    public R count(@RequestParam Map<String, Object> params,ZhiyuanzheEntity zhiyuanzhe, HttpServletRequest request){
        EntityWrapper<ZhiyuanzheEntity> ew = new EntityWrapper<ZhiyuanzheEntity>();
        int count = zhiyuanzheService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, zhiyuanzhe), params), params));

...
public interface JuanzengjiluService extends IService<JuanzengjiluEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<JuanzengjiluEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<JuanzengjiluEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<JuanzengjiluEntity> wrapper);

<template>
	<div class="main-content" :style='{"width":"100%","padding":"20px 30px","fontSize":"18px"}'>
		...
		<div v-if="!showFlag" style="width: 100%;">
			<el-form :style='{"border":"0px solid #fff","margin":"0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between"}' :inline="true" :model="searchForm" class="center-form-pv">
				<el-row :style='{"padding":"10px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex"}'>
					...
					<el-button class="search" :style='{"border":"0","cursor":"pointer","padding":"0 20px","color":"#fff","borderRadius":"4px","background":"#FCBB78","width":"auto","fontSize":"16px","height":"34px"}' type="success" @click="search()">
				...
				<el-table
					...
					<el-table-column
						...
						<template slot-scope="scope">
							<el-button
								type="text"
								:style='{"border":"0px solid #157ed2","cursor":"pointer","padding":"0 10px","margin":"0 5px 5px 0","color":"#fff","borderRadius":"4px","background":"url(http://codegen.caihongy.cn/20240908/2f72a776f9ee4717a0d3a514907c88b5.png) no-repeat center top / 100% 100%","width":"auto","fontSize":"16px","height":"32px"}'
								size="small"

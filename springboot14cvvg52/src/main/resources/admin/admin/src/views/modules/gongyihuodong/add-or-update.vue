	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="负责人" prop="zhiyuanzhexingming" >
					<el-input v-model="ruleForm.zhiyuanzhexingming" placeholder="负责人" clearable  :readonly="ro.zhiyuanzhexingming"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="负责人" prop="zhiyuanzhexingming" >
					<el-input v-model="ruleForm.zhiyuanzhexingming" placeholder="负责人" readonly></el-input>
				</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.huodongxiangqing = this.ruleForm.huodongxiangqing.replace(reg,'../../../springboot14cvvg52/upload');
					} else {
						this.$message.error(data.msg);
					}
				});

			...
			<el-form class="center-form-pv" :style='{"border":"0px solid #fff","margin":"0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"10px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex"}' >
					<div :style='{"alignItems":"center","margin":"0 10px 0 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">捐赠者姓名</label>
						<el-input v-model="searchForm.juanzengzhexingming" placeholder="捐赠者姓名" @keydown.enter.native="search()" clearable></el-input>
					</div>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('juanzengzhe','私聊')" type="success" @click="chatClick(scope.row)">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>
								私聊
							</el-button>
	...
	export default {
		...
		methods: {
			...
			chatClick(row) {
				...
				if(row.juanzengzhezhanghao){
					this.nowname = row.juanzengzhezhanghao
				}
			...
			getDataList() {
				...
				let params = {
 				...
 				if(this.searchForm.juanzengzhexingming!='' && this.searchForm.juanzengzhexingming!=undefined){
					params['juanzengzhexingming'] = '%' + this.searchForm.juanzengzhexingming + '%'
				}

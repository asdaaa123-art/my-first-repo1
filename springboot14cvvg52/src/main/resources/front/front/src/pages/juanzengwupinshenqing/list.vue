		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				<el-form-item class="list-item">
					...
					<el-input v-model="formSearch.shouzhuzhexingming" placeholder="受助者姓名" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-form-item class="list-item">
					<div class="lable">性别：</div>
					<el-input v-model="formSearch.xingbie" placeholder="性别" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-button class="list-search-btn" v-if=" true " type="primary" @click="getList(1, curFenlei)">
					<i class="el-icon-search"></i>
					查询
				</el-button>
				<el-button class="list-add-btn" v-if="btnAuth('juanzengwupinshenqing','新增')" type="primary" @click="add('/index/juanzengwupinshenqingAdd')">
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				let searchWhere = {};
				if (this.formSearch.shouzhuzhexingming != '') searchWhere.shouzhuzhexingming = '%' + this.formSearch.shouzhuzhexingming + '%';
				...
				this.$http.get(`juanzengwupinshenqing/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/juanzengwupinshenqingDetail', query: params});
			},

		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				<el-form-item class="list-item">
					...
					<el-input v-model="formSearch.fankuibianhao" placeholder="反馈编号" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-form-item class="list-item">
					<div class="lable">反馈名称：</div>
					<el-input v-model="formSearch.fankuimingcheng" placeholder="反馈名称" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-form-item class="list-item">
					<div class="lable">客服姓名：</div>
					<el-input v-model="formSearch.kefuxingming" placeholder="客服姓名" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-button class="list-search-btn" v-if=" true " type="primary" @click="getList(1, curFenlei)">
					<i class="el-icon-search"></i>
					查询
				</el-button>
				<el-button class="list-add-btn" v-if="btnAuth('wentifankui','新增')" type="primary" @click="add('/index/wentifankuiAdd')">
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				let searchWhere = {};
				if (this.formSearch.fankuibianhao != '') searchWhere.fankuibianhao = '%' + this.formSearch.fankuibianhao + '%';
				if (this.formSearch.fankuimingcheng != '') searchWhere.fankuimingcheng = '%' + this.formSearch.fankuimingcheng + '%';
				if (this.formSearch.kefuxingming != '') searchWhere.kefuxingming = '%' + this.formSearch.kefuxingming + '%';
				if(!this.centerType){
					params['sfsh'] = '是';
				}
				...
				this.$http.get(`wentifankui/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/wentifankuiDetail', query: params});
			},

		...
		<div class="detail-preview">
			<div class="attr">
				<div class="info">
					...
					<div class="btn_box">
						<el-button class="editBtn" v-if="btnAuth('zhiyuanzhe','修改')" @click="editClick">修改</el-button>
						<el-button class="delBtn" v-if="btnAuth('zhiyuanzhe','删除')" @click="delClick">删除</el-button>
						<el-button class="chatBtn" v-if="btnAuth('zhiyuanzhe','私聊')&&detail.id!=mid" @click="chatClick">私聊</el-button>
					</div>
				</div>
			</div>
			...
			init() {
				...
				this.$http.get(this.tablename + '/detail/'  + this.id, {}).then(res => {
					if (res.data.code == 0) {
						...
						if(res.data.data.zhiyuanzhezhanghao){
							this.fname = res.data.data.zhiyuanzhezhanghao
						}
